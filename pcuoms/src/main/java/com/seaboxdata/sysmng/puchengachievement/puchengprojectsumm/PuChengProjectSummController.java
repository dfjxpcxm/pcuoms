...
@Controller
@Scope("prototype")
@RequestMapping(value = "/puChengProjectSumm")
public class PuChengProjectSummController extends SysBaseController<PuChengProjectSummDO> {
    ...
    @Override
    public ISysBaseService<PuChengProjectSummDO> getBaseService() {
        return puChengProjectSummService;
    }

    @RequestMapping
    public String list(ModelMap model) {
        return "page/achievement/projectsumm/list";
    }

    @RequestMapping
    public String edit(ModelMap model) {
        return "page/achievement/projectsumm/edit";
    }

    @Override
    public DataStore save(PuChengProjectSummDO entity) {
        String imgPath = FileUtil.getImgUploadPath(request);
        entity.setModule_id(ModuleInfoConstants.ProjectSumm);
        if (imgPath.length() > 0)
