...
public class PuChengIndustIncmController extends SysBaseController<PuChengIndustIncmDO> {
    ...
    @Override
    public DataStore save(PuChengIndustIncmDO entity) {
        entity.setModule_id(ModuleInfoConstants.IndustIncm);
    ...
    @RequestMapping(value ="/pubIndustIncmInfoById")
    @ResponseBody
    public DataStore pubInfoById(@RequestParam String  imcome_id,@RequestParam String  pub_state) {
        puChengIndustIncmService.pubInfoById(imcome_id,pub_state);
